...
const GamePage = () => {
  ...
  const url = `https://mahadevregister.live/games/${game.slug}`;
  const jsonLd: object[] = [
    {
      ...
      inLanguage: "en-IN",
      isPartOf: { "@type": "WebSite", name: "Mahadev Book", url: "https://mahadevregister.live/" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      ...
      provider: { "@type": "Organization", name: "Mahadev Book", url: "https://mahadevregister.live/" },
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Games", item: "https://mahadevregister.live/games" },
