...
const GamePage = () => {
  ...
  const url = `https://mahadevvbooks.com/games/${game.slug}`;
  const jsonLd: object[] = [
    {
      ...
      inLanguage: "en-IN",
      isPartOf: { "@type": "WebSite", name: "Mahadev Book", url: "https://mahadevvbooks.com/" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Games", item: "https://mahadevvbooks.com/games" },
