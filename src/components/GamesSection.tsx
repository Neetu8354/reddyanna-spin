...
const CRICKET_GAMES = [
  { img: cricket, title: "IPL Betting", desc: "Bet on every IPL match, ball-by-ball live odds." },
  { img: cricket, title: "T20 World Cup", desc: "ICC T20 & 50-over World Cup live markets." },
  { img: cricket, title: "Test & ODI", desc: "Test matches, ODIs, BBL, PSL — every league." },
  { img: cricket, title: "Fancy Cricket", desc: "Session, lambi, over runs & toss markets." },
];

const CASINO_GAMES = [
  { img: teenpatti, title: "Teen Patti", desc: "India's favourite — 3-card live action." },
  { img: andarbahar, title: "Andar Bahar", desc: "Classic Indian card game with live dealers." },
  { img: roulette, title: "Roulette", desc: "European & Lightning roulette tables." },
  { img: blackjack, title: "Live Blackjack", desc: "Real dealers, real-time rounds, real ₹ wins." },
  { img: dragontiger, title: "Dragon Tiger", desc: "Fast-paced card battle, instant results." },
  { img: slots, title: "777 Slots", desc: "200+ premium slots with mega jackpots." },
];
...
const Card = ({ img, title, desc }: { img: string; title: string; desc: string }) => (
  <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"
    ...
    <div className="aspect-square overflow-hidden">
      <img src={img} alt={title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" loading="lazy" width={800} height={800} />
