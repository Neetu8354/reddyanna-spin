    ...
    <section id="home" className="relative overflow-hidden">
      ...
      <div className="relative container py-24 md:py-36 lg:py-44">
        <div className="max-w-3xl space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold/10 border border-gold/30 text-gold text-xs font-semibold tracking-wide uppercase">
            <Zap className="w-3.5 h-3.5" /> India's #1 Cricket Betting ID
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold leading-tight">
            ...
            <br />
            <span className="text-foreground/90 text-3xl md:text-5xl lg:text-6xl">Online Cricket Betting ID</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"
              className="group inline-flex items-center gap-3 px-7 py-4 rounded-full bg-gradient-gold text-primary-foreground font-bold text-base shadow-gold hover:shadow-gold-lg hover:scale-105 transition-all">
              <Trophy className="w-5 h-5" />
              Get Mahadev Book ID
            </a>
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-4 rounded-full border-2 border-gold/40 text-foreground font-semibold hover:bg-gold/10 transition-all">
