...
export const GAMES: GameDef[] = [
  {
    ...
    category: "Sports",
    title: "Online Cricket Betting India | Mahadev Register",
  ...
  },
  {
    ...
    title: "Play Teen Patti Online India | Mahadev Register",
    h1: "Play Teen Patti Online Real Money — Live Indian Card Game",
    description: "Play Teen Patti online with live dealers, INR payments, ₹100 minimum deposit and fast UPI withdrawals through Mahadev Register.",
    ...
    intro: "Teen Patti is India's favourite 3-card game. Play live, against real dealers, 24x7 on Mahadev Register — with AA Bonus, side bets and big jackpots, all in INR.",
    image: gameTeenpatti,
    alt: "Play Teen Patti online real money India on Mahadev Register",
    features: [
